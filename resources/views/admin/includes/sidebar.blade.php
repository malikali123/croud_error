        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ \Request::is('admin/users') || \Request::is('admin/users/*') ? 'open active' : ''  }}">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ url()->current() == route('admin.users.create') ? 'active' : ''  }}">
                        <a class="menu-item"
                           href="{{route('admin.users.create')}}" data-i18n="nav.dash.crypto">إضافة
                            مستخدم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ \Request::is('admin/employees') || \Request::is('admin/employees/*') ? 'active' : '' }}">
                        <a class="menu-item"
                           href="{{route('admin.emp')}}" data-i18n="nav.dash.crypto">
                            اضافة فرع جديد </a>
                    </li>
                </ul>
            </li>
