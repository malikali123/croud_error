        ...
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> تحديث بيانات الموظف / {{ $emp->full_name }}
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-body">
                ...
                <section id="basic-form-layouts">
                    ...
                    <form  action="{{route('admin.emp.update')}}" 
                            method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ old('full_name') ? old('full_name') : $emp->full_name }}" id="full_name"
                                                                   class="form-control"
                                                                   required
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ old('phone') ? old('phone') : $emp->phone }}" id="phone"
                                                                   class="form-control"
                                                                   required
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" value="{{ old('email') ? old('email') : $emp->email }}" id="email"
                                                                   class="form-control"
                                                                   required
                                                                   readonly
                                                                   placeholder="ادخل اسم الموظف  "
