            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ asset('/') }}">
                        <img class="brand-logo" alt="VISA Dashboard logo"
                             src="{{asset('assets/admin/img/logo.png')}}">
                             <h3 class="brand-text"> {{ auth()->user()->branch->name }}</h3>
                    </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                             <span class="mr-1">مرحباً<span class="user-name text-bold-700">{{ auth()->user()->full_name }}</span></span>
                            <span class="avatar avatar-online">
                                 <img  style="height: 35px;" src="{{ asset('storage/app/public/'.auth()->user()->image) }}" alt="avatar"><i></i>
                            </span>
                        </a>
