...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('assets/admin/images/ico/logo.png')}}">
    {{--<link--}}
    ...
    <style>
        ...
        .btn-info {
            border-color: #6f3011 !important;
            background-color: #6f3011 !important;
            color: #FFFFFF;
        ...
        .btn-info:hover {
            border-color: #6f3011 !important;
            background-color: #b17354 !important;
            color: #FFFFFF;
        }
