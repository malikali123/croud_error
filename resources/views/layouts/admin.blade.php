...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/vendors/css/extensions/sweetalert.css')}}">
...
<!-- Sweet-alert JS-->
<script src="{{asset('assets/admin/vendors/js/ui/jquery.sticky.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/admin/vendors/js/extensions/sweetalert.min.js')}}" type="text/javascript"></script>
...
<!-- BEGIN VENDOR JS-->
<script src="{{asset('assets/admin/js/datatables/datatables.min.js')}}"
...
<script src="{{asset('assets/admin/js/scripts/extensions/sweet-alerts.js')}}" type="text/javascript"></script>
