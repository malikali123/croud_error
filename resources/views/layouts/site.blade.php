...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/plugins/ui/jqueryui.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/front/css/site.css')}}">
{{--    <link rel="stylesheet" type="text/css" href="{{asset('assets/front/css/site.css')}}">--}}
    <!-- END Custom CSS-->
    @yield('style')
...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded "
...
<script src="{{asset('assets/admin/js/scripts/ui/jquery-ui/dialog-tooltip.min.js')}}" type="text/javascript"></script>
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
...
<script src="{{asset('assets/admin/js/bootstrap-notify.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/front/js/site.js')}}" type="text/javascript"></script>
@yield('script')
</body>
</html>
